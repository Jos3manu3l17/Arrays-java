...
public class Caso16 {
  ...
  public static void main(String[] args) {
    ...
    // Caso 16. Bibliotecología: Estadísticas de Circulación de Textos Una biblioteca registra el número de libros prestados 
    // diariamente durante un mes de 24 días hábiles. Los datos se almacenan en un vector. El sistema debe identificar los 
    // "Días de Baja Afluencia" (menos de 10 libros) y calcular el total de circulación mensual para planeación presupuestal.
